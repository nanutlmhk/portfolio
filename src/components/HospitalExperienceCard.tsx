...
export function HospitalExperienceCard({ experience }: HospitalExperienceCardProps) {
  return (
    <article className="rounded-[1.5rem] border border-slate-200/80 bg-white p-5 shadow-[0_18px_50px_-35px_rgba(15,23,42,0.35)] dark:border-slate-800 dark:bg-slate-900 sm:rounded-[1.75rem] sm:p-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h3 className="text-lg font-semibold text-slate-950 dark:text-white sm:text-xl">{experience.organization}</h3>
      ...
      <ul className="mt-5 space-y-2.5 text-sm leading-7 text-slate-700 dark:text-slate-200">

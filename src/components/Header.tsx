          ...
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-600 transition hover:border-cyan-300 hover:text-slate-950 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 dark:hover:border-cyan-500 dark:hover:text-white"
              >
                {theme === 'light' ? (
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-fit rounded-full border border-cyan-200 bg-cyan-50 px-4 py-2 text-sm font-semibold text-cyan-900 transition hover:border-cyan-300 hover:bg-cyan-100 dark:border-cyan-800 dark:bg-cyan-950/40 dark:text-cyan-100 dark:hover:bg-cyan-900/50"
              >
                {resumeButton}
              </a>
            </div>

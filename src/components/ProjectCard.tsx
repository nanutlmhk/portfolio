...
export function ProjectCard({ project, labels }: ProjectCardProps) {
  return (
    <article className="group rounded-[2rem] border border-slate-200/80 bg-white p-8 shadow-[0_20px_60px_-30px_rgba(15,23,42,0.28)] transition hover:-translate-y-1 hover:shadow-[0_24px_70px_-28px_rgba(8,145,178,0.24)] dark:border-slate-800 dark:bg-slate-900 dark:shadow-[0_22px_70px_-35px_rgba(2,8,23,0.85)]">
      ...
      <h3 className="mt-5 text-2xl font-semibold tracking-tight text-slate-950 dark:text-white">{project.title}</h3>
      <p className="mt-4 text-base leading-7 text-slate-600 dark:text-slate-300">{project.summary}</p>
